...
#include "sys/arch/x86/cons.h"
#include "sys/arch/x86/irq.h"	/* irq_enter_isr(), irq_leave_isr() */
#include "sys/arch/x86/asm.h"	/* _asm_outb, SYS_START */
#include "sys/crt/crt.h"		/* crt_memset16 */
