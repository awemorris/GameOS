...
#ifndef SYS_HAL_I386_ASM_H_
#define SYS_HAL_I386_ASM_H_
...
/*
 * Maximum Supported Memory Size in MB
 */
#define PHYSICAL_MEGS	(2048)
...
#define SIZE_INIT_STACK		(0x1000)	/* size of startup stack */
